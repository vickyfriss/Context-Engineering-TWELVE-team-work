...
st.title("Team Build-Up Style Analyst")
...
# Load team dataset
# -------------------------------
teams = TeamStats(data_folder="data/team_build_up_style_analyst")
...
if chat.state == "empty":
    ...
    display_names = {
        ...
        "prop_goalkeeper_involved": "Goalkeeper involved in buildup (%)",
        "avg_successful_passes": "Average successful passes in buildup",
        "avg_phase_duration_seconds": "Average phase duration (seconds)",
        "avg_players_involved": "Average players involved",
...
#    quality_plot.add_player(team, len(teams.df), metrics=quality_metrics)
    ...
    # Team summary
    description = TeamStyleDescription(team)
